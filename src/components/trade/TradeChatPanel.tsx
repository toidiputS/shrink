            ...
            <div className="flex-1 flex flex-col border-r border-border-subtle">
              ...
              <div className="p-6 border-t border-border-subtle bg-white/5">
                <form onSubmit={handleSendMessage} className="flex items-center gap-3">
                  ...
                  <button 
                    type="submit"
                    className="w-12 h-12 bg-accent-green hover:bg-accent-green/90 text-black rounded-xl flex items-center justify-center transition-colors shadow-lg shadow-accent-green/10"
                  >
              ...
              <div className="p-6 bg-white/5 border-t border-border-subtle space-y-4">
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button 
                    ...
                    disabled={deal.status === 'Finalized' || deal.status === 'Expired'}
                    className={cn(
                      "flex flex-col items-center gap-1.5 p-3 rounded-xl border transition-all disabled:opacity-50",
                      deal.myAgreed 
                ...
                {deal.status === 'Expired' && (
                  <button 
                    ...
                    className="w-full py-3 bg-accent-green text-black rounded-xl font-bold text-xs uppercase tracking-widest hover:bg-accent-green/90 transition-all flex items-center justify-center gap-2"
                  >
